...
// ANSWER: O(n) but this could be O(1) becuase we know the length of the numbers array
...
// ANSWER:O(n)  it could be O(1) because we know the length of the numbers array.
...
// ANSWER: O(1) No because its already O(1)
